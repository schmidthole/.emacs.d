...
;;;; +------------+
  (custom-theme-set-faces
   ...
   `(diff-hl-delete ((,class (:background ,nord11))))
    ...
    `(cider-fringe-good-face ((,class :foreground ,nord14)))
    `(cider-test-error-face ((,class :background ,nord11)))
    `(cider-test-failure-face ((,class :background ,nord11)))
    `(cider-test-success-face ((,class :foreground ,nord4 :background ,nord14)))
